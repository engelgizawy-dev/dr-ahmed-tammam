      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center items-center text-center px-6 pt-10 overflow-hidden">
        ...
        <div className="relative z-10 space-y-6 max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-10">
            <Link href="/auth/login" className="px-12 py-4 rounded-xl text-xl font-black bg-[#C8D749] text-[#070B14] hover:bg-[#b5c43d] hover:scale-105 transition-all duration-300 shadow-[0_0_30px_rgba(200,215,73,0.3)]">
              تسجيل الدخول
            </Link>
            <Link href="/auth/register" className="px-12 py-4 rounded-xl text-xl font-bold bg-transparent border border-[#0E5159] text-white hover:bg-[#0E5159]/20 transition-all duration-300">
              إنشاء حساب جديد
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 z-10 pb-20">
            <div className="flex items-center gap-4">
              <h2 className="text-5xl md:text-7xl font-black text-[#C8D749]">ليه دكتور أحمد تمام</h2>
            ...
            <Link href="/auth/register" className="inline-block mt-4 px-10 py-3 rounded-xl text-xl font-black bg-[#C8D749] text-[#070B14] hover:bg-[#b5c43d] hover:-translate-y-1 transition-all duration-300 shadow-[0_10px_20px_rgba(0,0,0,0.2)]">
              ابدأ رحلتك الآن
            </Link>
          </div>

          <div className="relative h-full min-h-[400px] flex items-end justify-center z-10 pb-10">
            {/* رجعتلك الرابط الأصلي بتاع الصورة الأولى */}
            <img 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-8 rounded-2xl bg-[#0D1524] border border-[#1A263D] hover:border-[#C8D749]/50 transition-colors group">
                <div className="w-12 h-12 rounded-lg bg-[#C8D749]/10 flex items-center justify-center text-[#C8D749] font-bold text-xl mb-6 group-hover:bg-[#C8D749] group-hover:text-black transition-colors">0{i+1}</div>
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          <div className="mb-10 flex flex-col items-center">
             <div className="flex items-center gap-2 opacity-90">
                ...
                <span className="text-3xl font-black text-white tracking-wider" dir="ltr">Tammam <span className="text-[#C8D749] text-lg font-bold">SOCIETY</span></span>
             </div>
          </div>
